...
// ═══════════════════════════════════════════════════════════════════
// Sophie Chat — concierge widget for marketing visitors.
// 
// Drawer UI in the bottom-right corner; expands to full-screen on demand.
// Talks to /api/public/concierge/talk on the same origin (no auth).
// Persists session_uuid in localStorage so a refresh resumes the conversation.
// History is fetched from /api/public/concierge/history/{uuid} on mount.
// ═══════════════════════════════════════════════════════════════════
(function(){
  ...
  window.SophieChat = function SophieChat({lang}) {
          ...
          <div className={`sophie-drawer ${fullscreen ? 'sophie-drawer--full' : ''}`}>
            <div className="sophie-drawer-head">
              <div className="sophie-head-left">
                <img src={(window.__resources||{}).avSophie || ''} alt="" className="sophie-head-avatar"/>
                <div>
