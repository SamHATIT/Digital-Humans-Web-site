// Legal module - Mod 28 (30 août 2026)
      ...
      "sections": [
        {
          ...
          "p": [
            ...
            "SIRET : 343 172 490 00033<br/>Adresse du siège : 40 rue Alexandre Dumas, 75011 Paris<br/>Numéro de TVA intracommunautaire : en cours d'attribution.",
        ...
        {
          "h": "Intelligence artificielle et contenus générés",
          "p": [
            "Digital·Humans est un système d'intelligence artificielle au sens du règlement (UE) 2024/1689 sur l'intelligence artificielle. Les agents avec lesquels vous échangez sur la Plateforme — Sophie, Olivia et l'ensemble de la troupe — ne sont pas des personnes : ce sont des programmes fondés sur des modèles de langage. Vous en êtes informé dès le premier contact, et ce rappel figure dans chaque conversation.",
            "Les livrables produits par la Plateforme — documents de spécification, schémas d'architecture, code Apex et LWC, configurations — sont des contenus générés par intelligence artificielle. Ils sont signalés comme tels dans le document et dans ses métadonnées, conformément à l'article 50 du règlement.",
            "Un contenu généré peut comporter des erreurs, des omissions, des approximations ou des références inexactes, y compris sous une apparence de certitude. Il ne constitue ni un conseil professionnel, ni une garantie de conformité, ni un engagement de résultat. La relecture, la validation et la décision d'usage relèvent du client, seul responsable des suites qu'il leur donne.",
            "L'éditeur ne saurait être tenu responsable des conséquences d'un usage des contenus générés sans revue humaine préalable, ni des décisions prises sur leur fondement.",
            "Les modèles utilisés sont fournis par Anthropic PBC et OpenAI Inc., ou exécutés sur l'infrastructure de l'éditeur ; les traitements de données afférents sont décrits dans la <a href=\"/privacy\">politique de confidentialité</a>.",
            "Tout contenu généré que vous jugeriez inexact, inapproprié ou préjudiciable peut être signalé à <a href=\"mailto:hello@digital-humans.fr\">hello@digital-humans.fr</a>."
          ]
        },
        {
          "h": "Droit applicable",
      ...
      "sections": [
        {
          ...
          "p": [
            ...
            "Business registration (SIRET): 343 172 490 00033<br/>Registered address: 40 rue Alexandre Dumas, 75011 Paris, France<br/>VAT registration: application in progress.",
        ...
        {
          "h": "Artificial intelligence and generated content",
          "p": [
            "Digital·Humans is an artificial intelligence system within the meaning of Regulation (EU) 2024/1689 on artificial intelligence. The agents you interact with on the Platform — Sophie, Olivia and the rest of the ensemble — are not people: they are programs built on language models. You are informed of this at first contact, and the reminder appears in every conversation.",
            "The deliverables produced by the Platform — specification documents, architecture designs, Apex and LWC code, configurations — are AI-generated content. They are labelled as such in the document and in its metadata, in accordance with Article 50 of the Regulation.",
            "Generated content may contain errors, omissions, approximations or inaccurate references, sometimes stated with apparent certainty. It constitutes neither professional advice, nor a guarantee of compliance, nor a commitment to results. Review, validation and the decision to use it rest with the customer, who alone is responsible for what follows.",
            "The publisher cannot be held liable for the consequences of using generated content without prior human review, nor for decisions taken on its basis.",
            "The models used are provided by Anthropic PBC and OpenAI Inc., or run on the publisher's own infrastructure; the related data processing is described in the <a href=\"/privacy\">privacy policy</a>.",
            "Any generated content you consider inaccurate, inappropriate or harmful can be reported to <a href=\"mailto:hello@digital-humans.fr\">hello@digital-humans.fr</a>."
          ]
        },
        {
          "h": "Governing law",
      ...
      "sections": [
        ...
        },
        {
          ...
          "p": [
            ...
            "<strong>Pro — 79 € HT par mois</strong> — Accès à l'ensemble des onze agents, upload de documents, mémoire persistante, deux Solution Design Specifications (SDS) par mois inclus. Pas de génération de code ni de déploiement.",
        ...
        },
        {
          ...
          "p": [
            "Les prix indiqués s'entendent hors taxes (HT). La TVA au taux en vigueur s'ajoute au prix affiché et apparaît sur la facture.",
        ...
        },
        {
          ...
          "p": [
            ...
            "Les livrables sont des contenus générés par intelligence artificielle, signalés comme tels. Le client reconnaît qu'ils peuvent comporter des erreurs et s'engage à les faire relire par une personne qualifiée avant tout usage ; l'éditeur ne répond pas des décisions prises sur leur fondement sans cette revue.",
      ...
      "sections": [
        ...
        },
        {
          ...
          "p": [
            ...
            "<strong>Pro — €79 / month (excl. VAT)</strong> — Access to all eleven agents, file upload, persistent memory, two SDS deliverables per month included. No code generation, no deployment.",
        ...
        },
        {
          ...
          "p": [
            "Prices are stated excluding tax. VAT at the applicable rate is added to the displayed price and shown on the invoice.",
        ...
        },
        {
          ...
          "p": [
            ...
            "Deliverables are AI-generated content and are labelled as such. The customer acknowledges that they may contain errors and undertakes to have them reviewed by a qualified person before any use; the publisher is not liable for decisions taken on their basis without such review.",
    ...
    "fr": {
      ...
      "sections": [
        ...
        },
        {
          "h": "8. Sécurité",
          "p": [
            "Les communications sont chiffrées en TLS. Les mots de passe sont stockés sous forme hachée. Les secrets d'API sont stockés dans des fichiers à accès restreint, lisibles par le seul administrateur système. Les sauvegardes de la base de données sont réalisées chaque semaine par notre hébergeur et conservées sur une infrastructure distincte située dans l'Union européenne.",
