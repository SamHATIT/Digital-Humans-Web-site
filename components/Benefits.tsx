        ...
        <section id="benefits" className="py-20 sm:py-28">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                     ...
                     <p className="mt-4 text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">We replace traditional consulting models with efficient, predictable, AI-driven automation.</p>
                </div>
